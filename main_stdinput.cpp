...
using meta_t = FactorMetaInfo<kAnchorNbVar,
                              kAnchorXDimTot,
                              kAnchorVarSizes,
                              kAnchorMesDim>;
 ...
 */
class AnchorFactor
    : public BaseFactor<AnchorFactor, meta_t, kAnchorCategoryName>
{
  public:
  AnchorFactor(const std::string&              factor_id,
               const AnchorFactor::var_keys_t& var_names)
      : BaseFactor<AnchorFactor, meta_t, kAnchorCategoryName>(factor_id,
                                                              var_names)
  {
  }
};
