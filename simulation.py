...
world = {
    ...
    [
        {
            "robot_id": "r1",
            "state": {"x": 5, "y": 6.1, "th": 0},
            "sensor": {"range": 18, "angle-coverage": 0.75}
        },
    ],
    "landmarks":
    [
        {"landmark_id": "l1", "state": {"x": 6, "y": 2}},
        {"landmark_id": "l2", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l3", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l4", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l5", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l6", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l7", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l8", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l9", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l10", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l11", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l12", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l13", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l14", "state": {"x": 36, "y": 10}},
        {"landmark_id": "l15", "state": {"x": 35, "y": 10}},
        {"landmark_id": "l16", "state": {"x": 36, "y": 10}},
    ]
}
