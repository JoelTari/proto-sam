...
int main(int argc, char* argv[])
{
  ...
  using system_t =
      typename sam::Inference::System<sam::Factor::Anchor2d, sam::Factor::RelativeMatcher2d>;
  auto syst = sam::Inference::System<sam::Factor::Anchor2d, sam::Factor::RelativeMatcher2d>(argId);
  int  fcount = 0;
