...
TEST(ToySLAMSE2System, Manif)
{
  ...
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b0", expected_b0_init, *all_positionLandmark.find("b0")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b1", expected_b1_init, *all_positionLandmark.find("b1")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b2", expected_b2_init, *all_positionLandmark.find("b2")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b3", expected_b3_init, *all_positionLandmark.find("b3")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b4", expected_b4_init, *all_positionLandmark.find("b4")->second.shared_mean);
  ...
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b0", expected_b0_map, *all_positionLandmark.find("b0")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b1", expected_b1_map, *all_positionLandmark.find("b1")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b2", expected_b2_map, *all_positionLandmark.find("b2")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b3", expected_b3_map, *all_positionLandmark.find("b3")->second.shared_mean);
  EXPECT_KEY_APPROX<::sam::Meta::Key::Spatial2d>("b4", expected_b4_map, *all_positionLandmark.find("b4")->second.shared_mean);
