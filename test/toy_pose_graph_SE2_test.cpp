...
class ToyPoseGraphSE2System : public ::testing::Test
{
  ...
  void SetUp() override
  {
    ...
    Eigen::Matrix<double, 3, 3> cov_pose_matcher
        = pose_matcher_sigmas.square().matrix().asDiagonal();
    Eigen::Matrix<double, 3, 3> chol_cov_pose_matcher = cov_pose_matcher.llt().matrixL();
    Eigen::Matrix<double, 3, 3> cov_loop_closure
        = loop_closure_sigmas.square().matrix().asDiagonal();
  ...
  void process_tests(SYS_T& sys)
  {
    ...
    EXPECT_EQ(sam::Inference::MatrixConverter::Scalar::JacobianNNZ(sys.get_all_factors()),
              9 + (6 * 18));
    ...
    EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>(
        "x0",
        expected_x0_init,
    ...
    EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>(
        "x3",
        expected_x3_init,
        *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x3")).value());
    EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>(
        "x4",
        expected_x4_init,
        *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x4")).value());
    EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>(
        "x5",
        expected_x5_init,
        *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x5")).value());
...
TEST_F(ToyPoseGraphSE2System, SparseNaive)
{
  ...
  // ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys
      = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseNaive,
...
TEST_F(ToyPoseGraphSE2System, SparseQR)
{
  ...
  // ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys
      = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseQR,
                                       ::sam::Factor::AnchorSE2,
                                       ::sam::Factor::RelativeMatcherSE2>("RelativeMatcherSLAM");
...
TEST_F(ToyPoseGraphSE2System, SparseSimplicialLLT)
{
  ...
  // ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys
      = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseSimplicialLLT,
                                       ::sam::Factor::AnchorSE2,
                                       ::sam::Factor::RelativeMatcherSE2>("RelativeMatcherSLAM");
...
TEST_F(ToyPoseGraphSE2System, SparseSupernodalLLT)
{
  ...
  // ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys
      = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseSupernodalLLT,
                                       ::sam::Factor::AnchorSE2,
                                       ::sam::Factor::RelativeMatcherSE2>("RelativeMatcherSLAM");
...
TEST_F(ToyPoseGraphSE2System, SparsePardisoLLT)
{
  ...
  // ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys
      = ::sam::Inference::SparseSystem<sam::Inference::SolverSparsePardisoLLT,
                                       ::sam::Factor::AnchorSE2,
                                       ::sam::Factor::RelativeMatcherSE2>("RelativeMatcherSLAM");
