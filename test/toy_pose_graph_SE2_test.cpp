...
//                          SetUp Fixture                           //
//------------------------------------------------------------------//
class ToyPoseGraphSE2System : public ::testing::Test
{
  protected:
    void SetUp() override
    {
      ...
      // f0 anchor
      {
        ...
        // registration
        this->AnchorBundle.push("f0", z, cov_z, {"x0"});
      }
      // f1:  x0 to x1
      {
        ...
        // registration
        this->RelativeMatcherBundle.push("f1", z, cov_z, {"x0", "x1"});
      }  
      // odometry pose matcher  x1 to x2
      {
        ...
        auto               cov_z              = cov_pose_matcher;
        // registration
        this->RelativeMatcherBundle.push("f2", z, cov_z, {"x1", "x2"});
      }
      // odometry pose matcher  x2 to x3
      {
        ...
        auto               cov_z = cov_pose_matcher;
        // registration
        this->RelativeMatcherBundle.push("f3", z, cov_z, {"x2", "x3"});
      }
      // odometry pose matcher  x3 to x4
      {
        ...
        auto               cov_z = cov_pose_matcher;
        // registration
        this->RelativeMatcherBundle.push("f4", z, cov_z, {"x3", "x4"});
      }
      // odometry pose matcher  x4 to x5
      {
        ...
        auto               cov_z = cov_pose_matcher;
        // registration
        this->RelativeMatcherBundle.push("f5", z, cov_z, {"x4", "x5"});
      }
      // loop closure from x5 to x0
      {
        ...
        // registration
        this->RelativeMatcherBundle.push("f6", z, cov_z, {"x0", "x5"});
      }

    }

    PreRegistrationBundle<AnchorSE2> AnchorBundle;
    PreRegistrationBundle<RelativeMatcherSE2> RelativeMatcherBundle;
    ...
    void process_tests(SYS_T& sys)
    {
      ...
      sys.template register_factors_in_bundle<sam::Factor::AnchorSE2>(AnchorBundle.vfid,
                                                                      AnchorBundle.vmeasure,
                                                                      AnchorBundle.vmeasure_cov,
                                                                      AnchorBundle.vkeys_id);
      // register bundle RelativeMatcher
      sys.template register_factors_in_bundle<sam::Factor::RelativeMatcherSE2>(
      ...
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x0", expected_x0_init, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x0")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x1", expected_x1_init, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x1")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x2", expected_x2_init, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x2")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x3", expected_x3_init, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x3")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x4", expected_x4_init, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x4")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x5", expected_x5_init, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x5")).value());
      ...
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x0", expected_x0_map, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x0")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x1", expected_x1_map, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x1")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x2", expected_x2_map, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x2")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x3", expected_x3_map, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x3")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x4", expected_x4_map, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x4")).value());
      EXPECT_KEY_APPROX<::sam::Meta::Key::SpatialSE2>("x5", expected_x5_map, *(sys_marginals.template find_mean_ptr<sam::Meta::Key::SpatialSE2>("x5")).value());
    }
};
...
//------------------------------------------------------------------//
//------------------------------------------------------------------//
TEST_F(ToyPoseGraphSE2System, SparseNaive)
{
  // logger
  ...
  // auto sys = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseQR, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys = ::sam::Inference::SparseSystem<
    sam::Inference::SolverSparseNaive, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
      "RelativeMatcherSLAM");
...
TEST_F(ToyPoseGraphSE2System, SparseQR)
{
  // logger
  sam_utils::JSONLogger::Instance().beginSession("gtest_pose_graph", "toy_square_pose_graph_SE2");
  // scoped Timer
  ...
  // auto sys = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseQR, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys = ::sam::Inference::SparseSystem<
    sam::Inference::SolverSparseQR, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
      "RelativeMatcherSLAM");


  this->process_tests(sys);
}
TEST_F(ToyPoseGraphSE2System, SparseSimplicialLLT)
{
  // logger
  sam_utils::JSONLogger::Instance().beginSession("gtest_pose_graph", "toy_square_pose_graph_SE2");
  // scoped Timer
  ...
  // auto sys = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseQR, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys = ::sam::Inference::SparseSystem<
    sam::Inference::SolverSparseSimplicialLLT, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
      "RelativeMatcherSLAM");


  this->process_tests(sys);
}
TEST_F(ToyPoseGraphSE2System, SparseSupernodalLLT)
{
  // logger
  sam_utils::JSONLogger::Instance().beginSession("gtest_pose_graph", "toy_square_pose_graph_SE2");
  // scoped Timer
  ...
  // auto sys = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseQR, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys = ::sam::Inference::SparseSystem<
    sam::Inference::SolverSparseSupernodalLLT, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
      "RelativeMatcherSLAM");
...
TEST_F(ToyPoseGraphSE2System, SparsePardisoLLT)
{
  // logger
  sam_utils::JSONLogger::Instance().beginSession("gtest_pose_graph", "toy_square_pose_graph_SE2");
  // scoped Timer
  ...
  // auto sys = ::sam::Inference::SparseSystem<sam::Inference::SolverSparseQR, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
  auto sys = ::sam::Inference::SparseSystem<
    sam::Inference::SolverSparsePardisoLLT, ::sam::Factor::AnchorSE2, ::sam::Factor::RelativeMatcherSE2>(
      "RelativeMatcherSLAM");
